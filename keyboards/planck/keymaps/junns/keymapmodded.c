...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_QWERTY] = LAYOUT_planck_grid(
      ...
      KC_LCTL, FN,      KC_LALT, KC_LGUI, SPACE_FN,   SPACE_FN,  LOWER,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
  ...
  */
  [_LOWER] = LAYOUT_planck_grid(
      ...
      _______, XXXXXXX, _______, _______, KC_SPC, KC_SPC,   _______,   _______,  KC_0,    KC_DOT,   KC_EQL,   XXXXXXX
  ),
  ...
  */
  [_RAISE] = LAYOUT_planck_grid(
      ...
      _______,  XXXXXXX, _______,  _______,    KC_SPC,  KC_SPC,   _______,   _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
  ),
  ...
  */
  [_FN] = LAYOUT_planck_grid(
      ...
      XXXXXXX,        _______, XXXXXXX, XXXXXXX, KC_SPC,  KC_SPC,   XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  */
  [_SPACE_FN] = LAYOUT_planck_grid(
      ...
      XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,     XXXXXXX,    XXXXXXX,
      XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,   _______,  _______,  XXXXXXX,  XXXXXXX, KC__MUTE, KC__VOLDOWN, KC__VOLUP,  XXXXXXX
  ),
